...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="/CodeIgniter-3.1.6/resource/css/seastyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="/CodeIgniter-3.1.6/resource/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="/CodeIgniter-3.1.6/resource/js/script.js"></script>
	</head>
					...
					<div class="menu-hd">
						<?php
                                ...
                                if(isset($_SESSION['useremail'])) {
                                    ...
                                    echo "<a href='show_login' target='_top' class='h'>"."欢迎您，".$_SESSION['useremail']."</a>";
...
<!--					<div class="menu-hd"><a href="#" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span></a></div>-->
           ...
           <div class="search">
			...
			<div class="nav-table">
					   <div class="long-title"><span class="all-goods">搜 索 结 果</span></div>
					   <div class="nav-cont">
<!--
							<ul>
...
-->
							...
							<div class="search-content">
								<div class="sort">
<!--
									<li class="first"><a title="综合">结 果 共 
                                        <?php
                                                ...
                                                foreach($data as $row){
                                                    echo "<li>
                                                        <div class='i-pic limit'>
                                                            "."<a href='show_introdution/".$row->bid."'><img src='/CodeIgniter-3.1.6/resource/images/".$row->bname."_mid.jpg' /></a>											
                                                            <p class='title fl'>".$row->bname."</p>
                                                            <p class='price fl'>
                                                                <b>¥</b>
                                                                <strong>".$row->bprice."</strong>
                                                            </p>
                                                        </div>
                                                    </li>";
                                                }
