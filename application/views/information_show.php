					...
					<div class="am-container header">
						...
						<ul class="message-r">
							...
							<div class="topMessage mini-cart">
								<div class="menu-hd"><a id="mc-menu-hd" href="#" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>我的订单</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
							</div>
...
-->
								<li>
                                    ...
                                    <div class="m-left">
								        <div class="fore1"><?php echo $row->gender; ?></div>
									</div>
<!--
									<div class="fore3">
										<a href="idcard.html">
											<div class="am-btn am-btn-secondary"><?php echo $row->gender; ?></div>
										</a>
									</div>
-->
								</li>
								<li>
									...
									<div class="m-left">
								        <div class="fore1"><?php echo $row->phone_number; ?></div>
									</div>
								</li>
								<li>
                                    ...
                                    <div class="m-left">
								        <div class="fore1"><?php echo $row->uemail; ?></div>
									</div>
<!--
									<div class="fore3">
										<a href="email.html">
											<div class="am-btn am-btn-secondary"><?php echo $row->uemail; ?></div>
										</a>
									</div>
-->
								</li>
                                ...
                                <li>
                                    ...
                                    <div class="m-left">
								        <div class="fore1"><?php echo $row->birthday; ?></div>
									</div>
<!--
									<div class="fore3">
										<a href="email.html">
