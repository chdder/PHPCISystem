...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="/CodeIgniter-3.1.6/resource/css/jsstyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="/CodeIgniter-3.1.6/resource/js/address.js"></script>
					...
					<div class="menu-hd">
						<?php
                                ...
                                if(isset($_SESSION['useremail'])) {
                                    ...
                                    echo "<a target='_top' class='h'>"."欢迎您，".$_SESSION['useremail']."</a>";
...
<!--
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay card"><img src="/CodeIgniter-3.1.6/resource/images/wangyin.jpg" />银联<span></span></li>
							<li class="pay qq"><img src="/CodeIgniter-3.1.6/resource/images/weizhifu.jpg" />微信<span></span></li>
							<li class="pay taobao"><img src="/CodeIgniter-3.1.6/resource/images/zhifubao.jpg" />支付宝<span></span></li>
						</ul>
					</div>
-->
					<div class="clear"></div>
										...
										<ul class="item-content clearfix">
											<div class="pay-phone">
												<li class="td td-item">
													<div class="item-pic">
                                                        <?php
														  echo "<a href='/CodeIgniter-3.1.6/index.php/login_contrl/show_introdution/".$iarray['bid']."' class='_MakePoint'>
															<img src='/CodeIgniter-3.1.6/resource/images/".$iarray['c_name']."_small.jpg' class='itempic J_ItemImg'></a>";
                                                        ?>
													</div>
													<div class="item-info">
													           ...
													           <em class='J_Price price-now' tabindex='0'>
                                                                <?php
                                                                    ...
                                                                    if(isset($iarray)){
                                                                        ...
                                                                        echo $iarray['total_price']/$iarray['quantity'];
                                                                    }
                                                                 ?>  
                                                               </em>
												            </div>
...
<!--															<input class="min am-btn" name="" type="button" value="-" />-->
															<?php
                                                                echo "<input disabled='disabled' class='text_box' name='' type='text' value='".$iarray['quantity']."' style='width:30px;' />";
                                                            ?>
...
-->
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
									<div class="box">
										<div tabindex="0" id="holyshit267" class="realPay"><em class="t">预定总金额：</em>
...
<!--										</div>-->
									...
									<div id="holyshit269" class="submitOrder">
										<div class="go-btn-wrap">
                                            <?php
                                                echo "<a id='J_Go' href='/CodeIgniter-3.1.6/index.php/login_contrl/show_success/".$iarray['bid']."/".$iarray['quantity']."' class='btn-go' tabindex='0' title='点击此按钮，提交订单'>提交订单</a>";
                                                $_SESSION['payed']=0;
                                            ?>
										</div>
									</div>
